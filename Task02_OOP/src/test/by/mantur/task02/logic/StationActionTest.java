package test.by.mantur.task02.logic;
...
import by.mantur.task02.logic.StationAction;

public class StationActionTest {
	...
	public void calculateStationCostTest() {
		StationAction.calculateStationCost(carsList);
	}
